...
if choice == "Home":
    ...
    st.image(image,caption=None, width=500, use_column_width=50, clamp=False, channels="RGB", output_format="auto")
    ...
    st.image(image,caption=None, width=50, use_column_width=10, clamp=False, channels="RGB", output_format="auto")
